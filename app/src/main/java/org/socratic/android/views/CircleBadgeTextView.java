 ...
 * <p>
 * Re-purposing a custom badge text view found here
...
public class CircleBadgeTextView extends AppCompatTextView {
    ...
    public CircleBadgeTextView(final Context context) {
        this(context, null);
    }

    public CircleBadgeTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleBadgeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CircleBadgeTextView);
        backgroundColor = typedArray.getColor(R.styleable.CircleBadgeTextView_android_background, Color.WHITE);
        borderColor = typedArray.getColor(R.styleable.CircleBadgeTextView_mbtv_border_color, Color.TRANSPARENT);
        borderWidth = typedArray.getDimension(R.styleable.CircleBadgeTextView_mbtv_border_width, 0);
        borderAlpha = typedArray.getFloat(R.styleable.CircleBadgeTextView_mbtv_border_alpha, 1);
        ctType = typedArray.getInt(R.styleable.CircleBadgeTextView_mbtv_type, DEFAULT_FILL_TYPE);
        typedArray.recycle();
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        MultiLog.d("CircleBadgeTextView", "onTextChanged() " + text);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        MultiLog.d("CircleBadgeTextView", "onSizeChanged()");
        refreshBackgroundDrawable(w, h);
    }

    private void refreshBackgroundDrawable(int targetWidth, int targetHeight) {
        MultiLog.d("CircleBadgeTextView", "refreshBackgroundDrawable()");
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = CircleBadgeTextView.this.getWidth();
            final int viewHeight = CircleBadgeTextView.this.getHeight();
