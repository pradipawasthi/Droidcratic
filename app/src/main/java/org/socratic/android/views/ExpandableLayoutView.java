...
import static org.socratic.android.views.ExpandableLayoutView.State.COLLAPSED;
import static org.socratic.android.views.ExpandableLayoutView.State.COLLAPSING;
import static org.socratic.android.views.ExpandableLayoutView.State.EXPANDED;
import static org.socratic.android.views.ExpandableLayoutView.State.EXPANDING;
...
public class ExpandableLayoutView extends FrameLayout {
    ...
    public ExpandableLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);

        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableLayoutView);
            duration = a.getInt(R.styleable.ExpandableLayoutView_el_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.ExpandableLayoutView_el_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.ExpandableLayoutView_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.ExpandableLayoutView_el_parallax, 1);
            a.recycle();
    ...
    private void animateSize(int targetExpansion) {
        MultiLog.d("ExpandableLayoutView", "animateSize() -> targetExpansion -> " + targetExpansion);
        if (animator != null) {
            animator.cancel();
            animator = null;
        }
